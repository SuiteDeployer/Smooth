-- Migration: fix_user_roles_column_reference
-- Created at: 1754357353

-- Corrigir referência à coluna name que não existe na tabela user_roles
-- A coluna correta é role_name
...
BEGIN
    ...
    -- Buscar hierarquia do investidor e criar comissões (CORRIGIDO: ur.role_name em vez de ur.name)
    FOR v_recipient IN (
