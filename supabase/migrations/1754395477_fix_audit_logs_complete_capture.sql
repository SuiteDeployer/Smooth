...
INSERT INTO audit_logs (
    ...
    ('sistema', 'SYSTEM', 'SYSTEM', 'AUDIT', 'Sistema de auditoria atualizado e triggers configurados', NOW(), NOW()),
    ('admin@smooth.com.br', 'Global', 'VIEW', 'AUDIT', 'Visualização do dashboard de auditoria', NOW(), NOW());
