-- Migration: create_commission_calculation_functions
-- Created at: 1754328459

-- STEP 2: Funções para cálculo automático de comissões

-- Função para gerar sequence de payment_id único
CREATE SEQUENCE IF NOT EXISTS commission_payment_id_seq START 100001;

-- Função para calcular comissões automaticamente quando um investimento é criado
