-- Migration: fix_commission_calculation_percentages
-- Created at: 1754332209

-- Migration: fix_commission_calculation_percentages
-- Corrigir função de cálculo de comissões para usar os percentuais corretos da tabela investments
...
BEGIN
    ...
    LOOP
        -- **CORREÇÃO**: Usar os percentuais corretos da tabela investments
