-- Migration: fix_commission_duplicate_key_error
-- Created at: 1754356184

-- Fix duplicate key error in commission calculation
...
BEGIN
    ...
    SELECT maturity_period_months INTO v_series_duration
