-- Migration: create_commission_views
-- Created at: 1754328533

-- STEP 5: Criar views para facilitar consultas e relatórios
...
SELECT 
    ...
    cs.payment_month,
    cs.installment_number,
    EXTRACT(days FROM (CURRENT_DATE - cs.payment_month)) as days_overdue
FROM commission_payments cp
JOIN commission_schedules cs ON cp.commission_schedule_id = cs.id
