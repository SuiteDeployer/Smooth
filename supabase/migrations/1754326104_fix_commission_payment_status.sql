-- Migration: fix_commission_payment_status
-- Created at: 1754326104

-- Corrigir função de cálculo de comissões para usar valores corretos de payment_status
...
CREATE TRIGGER trigger_calculate_commissions
    ...
    FOR EACH ROW EXECUTE FUNCTION calculate_investment_commissions();;